AOS.init({
  ...
  let tooltipInterval; // to store interval ID

  function showTooltip() {
    tooltipInterval = setInterval(function () {
      $('#whatsapp-tooltip').fadeOut(500, function () {
        setTimeout(function () {
          $('#whatsapp-tooltip').fadeIn(500);
        }, 2000); // show again after 5s
      });
    }, 2000);
  }
  ...
  $(document).ready(function () {
    ...
    $('#close-tooltip').on('click', function () {
      clearInterval(tooltipInterval);        // stop repeated showing
      $('#whatsapp-tooltip').fadeOut();      // hide immediately
    });
  });
...
$(document).ready(function () {
  ...
  // phone menu
  function phoneMenu() {
    $("#phoneHeader li:first").addClass("active-link");

    $("#phoneHeader li").click(function () {
      $("#phoneHeader li").removeClass("active-link");
      $(this).addClass("active-link");

      setTimeout(() => {
        $("#phoneHeader").removeClass("openPhoneHeader");
      }, 500);
    });

    // for bottom button
    $("#phoneHeader a").click(function () {
      setTimeout(() => {
        $("#phoneHeader").removeClass("openPhoneHeader");
      }, 500);
    });
  ...
  function toggleMenu() {
    $("#menuToggle").click(function (e) {
      ...
      $("#phoneHeader").toggleClass("openPhoneHeader");
    });
  ...
  // All Carousal Sliders
  function AllCarousalSlider() {
    ...
    testimonal1.owlCarousel({
      ...
      responsive: {
        ...
        1280: { items: 4, dots: false },
        1536: { items: 5, dots: false },
      },
    });
  ...
  function Clients() {
    ...
    repeatedLogos.forEach((logo) => {
      ...
      img.src = `./img/clients/choosed/${logo}`;
      img.alt = logo;
      img.title = logo;
      img.className =
        "w-full h-full object-contain grayscale-100 hover:grayscale-0";
